...
Spawns a Digit V3 on rough terrain with flat-patch sampling.
...
from mjlab.tasks.velocity.config.digit_v3.env_cfgs import digit_v3_rough_env_cfg
...
def main(viewer: str = "auto") -> None:
  ...
  cfg = digit_v3_rough_env_cfg(play=True)
