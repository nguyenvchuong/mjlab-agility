...
.. code-block:: python
    ...
    from .env_cfgs import digit_v3_rough_env_cfg, digit_v3_flat_env_cfg
    from .rl_cfg import digit_v3_ppo_runner_cfg
...
.. code-block:: bash
    ...
    uv run train Mjlab-Velocity-Flat-Digit-V3 --num-envs 4096
...
.. code-block:: bash
    ...
    # See all flags.
    uv run train Mjlab-Velocity-Flat-Digit-V3 --help

    # Search for a specific field.
    uv run train Mjlab-Velocity-Flat-Digit-V3 --help | grep learning-rate
...
.. code-block:: bash
    ...
    # From W&B.
    uv run play Mjlab-Velocity-Flat-Digit-V3 \
        --wandb-run-path your-entity/mjlab/run-id

    # From a local checkpoint.
    uv run play Mjlab-Velocity-Flat-Digit-V3 \
        --checkpoint-file logs/rsl_rl/digit_velocity/2025-01-27_14-30-00/model_1000.pt
...
Digit V3 velocity task shows a typical configuration:
