...
.. code-block:: python
   ...
   from mjlab.asset_zoo.robots.digit_v3.digit_constants import get_digit_robot_cfg
   ...
   digit_cfg = replace(get_digit_robot_cfg(), sensors=(self_collision_sensor,))

   # Create scene
   SCENE_CFG = SceneCfg(
       terrain=TerrainEntityCfg(terrain_type="plane"),
       entities={"robot": digit_cfg},
   )
