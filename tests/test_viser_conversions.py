...
def load_robot_model(robot_name: str) -> mujoco.MjModel:
  ...
  robot_paths = {
    "digit_v3": base_path / "digit_v3/digit.xml",
  }
...
def test_digit_v3_conversion():
  """Test conversion with Digit V3 robot."""
  model = load_robot_model("digit_v3")
  ...
  assert mesh_geom_count > 0, "No mesh geometries found in Digit V3"
  print(f"✓ Digit V3: Successfully converted {mesh_geom_count} mesh geometries")
  if has_textures:
